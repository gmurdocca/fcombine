...
var SelectFilter = {
	...
	//quickElement('h2', selector_available, interpolate(('Available %s'), [field_name]));
	quickElement('h2', selector_available, 'Available ' + field_name);
	var filter_p = quickElement('p', selector_available, '');
	filter_p.className = 'selector-filter';
	quickElement('img', filter_p, '', 'src', admin_media_prefix + 'xsftp/selector-search.gif');
	...
	//quickElement('h2', selector_chosen, interpolate(('Chosen %s'), [field_name]));
	quickElement('h2', selector_chosen, 'Chosen ' + field_name);
	var selector_filter = quickElement('p', selector_chosen, ('Select choices and click '));
	selector_filter.className = 'selector-filter';
	quickElement('img', selector_filter, '', 'src', admin_media_prefix + (is_stacked ? 'xsftp/selector_stacked-add.gif':'xsftp/selector-add.gif'), 'alt', 'Add');
